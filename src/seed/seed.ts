...
async function main() {
  ...
  await payload.updateGlobal({
    ...
    data: {
      navItems: [
        ...
        { label: 'Ocean Rescue (Ghost Fleet)', href: '/ghost-fleet' },
        { label: 'How We Help', href: '/services' },
        { label: 'Our Advocates', href: '/team' },
        { label: 'Our Allies', href: '/projects' },
        { label: 'Voices & Stories', href: '/blog' },
        { label: 'Press & Updates', href: '/news' },
  ...
  await payload.updateGlobal({
    ...
    data: {
      navItems: [
        { label: 'รู้จัก LPN', href: '/about' },
        { label: 'ช่วยเหลือประมง (Ghost Fleet)', href: '/ghost-fleet' },
        { label: 'งานช่วยเหลือแรงงาน', href: '/services' },
        { label: 'ทีมผู้พิทักษ์สิทธิ์', href: '/team' },
        { label: 'เครือข่ายพันธมิตร', href: '/projects' },
        { label: 'เสียงสะท้อนและเรื่องเล่า', href: '/blog' },
        { label: 'ความเคลื่อนไหวล่าสุด', href: '/news' },
